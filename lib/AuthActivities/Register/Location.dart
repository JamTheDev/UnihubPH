...
class _LocationState extends State<Location> {
  ...
  void _validateTextViews(){
    if(forms.currentState.validate()){
      ...
      RegisterInformation.city = firstName;
      RegisterInformation.province = lastName;
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Text(
                            "Let your city be known through this app!!",
                            style: TextStyle(
                                fontFamily: "Sen",
                                fontSize: 20,
                                color: Colors.white),
                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            ...
                            child: Text("City", style: TextStyle(fontSize: 15, fontFamily: "Sen", color: Colors.grey), textAlign: TextAlign.left,),
                          ),
                          Container(
                          ...
                          Container(
                            ...
                            child: Text("Province", style: TextStyle(fontSize: 15, fontFamily: "Sen", color: Colors.grey)),
                          ),
                          Container(
                            margin: EdgeInsets.fromLTRB(30, 0, 30, 20),
                            child: TextFormField(
